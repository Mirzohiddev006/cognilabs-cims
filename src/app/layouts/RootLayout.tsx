      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : 'radial-gradient(circle at top, rgba(59,130,246,0.05), transparent 32%), linear-gradient(180deg, #f3f5f9, #eaecf2)',
        }}
      >
        <div
          ...
          style={{
            background: isDark
              ...
              : 'radial-gradient(circle at top, rgba(59,130,246,0.06), transparent 70%)',
          }}
        />
