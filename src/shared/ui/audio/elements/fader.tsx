  ...
  return (
    ...
    >
      ...
      >
        ...
        <FaderPrimitive.Thumb className={cn(faderThumbVariants({ size }), 'data-[disabled=true]:cursor-not-allowed')}>
          <FaderPrimitive.ThumbInner className="flex h-full w-full items-center justify-center gap-0.5 data-[orientation=horizontal]:flex-row data-[orientation=horizontal]:px-1.5 data-[orientation=horizontal]:py-1">
            {thumbMarks !== false &&
